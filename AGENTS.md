...
config/nm-live-view  private Herdr no-mistakes companion preference; LOCAL, gitignored; inherited by secondmate homes; read docs/configuration.md when configuring or inheriting it and docs/codex-app-backend.md "No-mistakes live companion" when operating or recovering the companion
...
state/               volatile runtime signals; gitignored
  ...
  <id>.nm-live  private exact-identity state for an eligible no-mistakes Codex companion; may outlive task metadata for focus-safe deferred cleanup; see docs/codex-app-backend.md "No-mistakes live companion"
