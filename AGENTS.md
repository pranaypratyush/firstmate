...
config/nm-live-view  optional "off" opt-out from the default-on Herdr companion for eligible no-mistakes Codex threads; LOCAL, gitignored; inherited by secondmate homes; see docs/codex-app-backend.md "No-mistakes live companion"
