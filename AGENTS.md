...
state/               volatile runtime signals; gitignored
  ...
  <id>.adopted-brief.md  generated identity and setup override for a task that adopts an existing worktree; removed by teardown; see bin/fm-spawn.sh's header
  <id>.adopted-endpoint  forward-only Herdr existing-worktree endpoint transaction; task authority requires matching complete metadata; see docs/herdr-backend.md "Existing-worktree adoption"
