...
- [docs/indexing-tools-cachyos.md](docs/indexing-tools-cachyos.md) - recover the local grepai, CodeGraph, Serena, and optional lazy-mcp indexing stack on CachyOS/Arch.
