...
family_for_basename() {
  case "$1" in
    ...
    fm-brief.test.sh|fm-no-mistakes-attach.test.sh|fm-vendor-auth-probe.test.sh|\
    ...
    fm-herdr-version-floor-live-e2e.test.sh|fm-herdr-same-home-binding-live-e2e.test.sh|\
