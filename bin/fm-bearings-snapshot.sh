...
Default fields: schema, home, generated, prs,
  ...
  landed{id,what,outcome,outcome_evidence_available,outcome_evidence_gap,context,context_*_truncated,context_report_count_omitted,caveat,next_action,next_action_truncated,next_owner,artifact,owner},
