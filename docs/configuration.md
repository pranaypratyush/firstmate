...
Its durable ownership record supports collision-free same-task recovery, and `fm-teardown.sh` applies normal report and landed-work gates while retiring only Firstmate task state and endpoints, never the adopted worktree or branch.
